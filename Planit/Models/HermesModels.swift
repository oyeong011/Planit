import Foundation
import SwiftData
// MemoryCategory / MemoryFact / PlanningDecision / PlanningDecision.DecisionOutcome은
// 플랫폼 중립 value type이므로 Shared로 승격됨. macOS 코드가 그대로 심볼을 참조할 수
// 있도록 @_exported import로 재노출한다 (M1 Step 3).
